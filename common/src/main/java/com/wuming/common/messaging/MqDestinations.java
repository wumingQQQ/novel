...
public final class MqDestinations {
    ...
    public static final String CHAPTER_SPLIT_COMPLETED_TAG = "chapter_split_completed";
    ...
    public static final String CHAPTER_SPLIT_COMPLETED =
            destination(NOVEL_EVENTS_TOPIC, CHAPTER_SPLIT_COMPLETED_TAG);
